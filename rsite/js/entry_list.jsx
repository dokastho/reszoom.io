                    ...
                    <form encType="multipart/form-data">
                      {
                        ...
                        isEntries ? (
                          ...
                          <div>
                            ...
                            <input type="button" onSubmit={(event) => this.updateEntry(event, e.entryid, idx, isEntries)} value="Submit edit for this resume" />
                            {e.frequency > 1 ? <input type="button" onSubmit={(event) => this.updateEntry(event, e.entryid, idx, isEntries)} value="Submit edit for all resumes" /> : null }
                          </div>
                        )
                      }
