...
class Entries extends React.Component {
  ...
  // create an entry
  createEntry(entryid, type, subheader, event) {
    ...
    fetch(`/api/v1/entry/?resumeid=${resumeid}&entryid=${entryid}&header=${header}&type=${type}&begin=${begin}&end=${end}&gpa=${gpa}&subheader=${subheader}&operation=create`, {
    ...
    return (
      <div>
        ...
        {/* render create form */}
        {
          ...
          isEntries
            ? (
              <form onSubmit={(event) => this.createEntry(0, 1, parent, event)}>
            ...
            : (
              add
                ? (
                  <form onSubmit={(e) => this.createEntry(0, 0, parent, e)}>
