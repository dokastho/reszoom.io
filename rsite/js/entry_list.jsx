                ...
                ? (
                  <span>
                    <form onSubmit={(e) => this.createEntry(e, 0)}>
                      ...
                      {isEducation ? <input type="number" required step="0.01" onChange={(event) => this.handleEntryChange(event, 0, 'gpa')} value={stagedEntries[0].gpa} min="0.0" max="4.0" placeholder="GPA" /> : null}
                      <button type="button" onClick={this.setAddFalse.bind(this, 0)}>Cancel</button>
                      <input type="submit" />
                    </form>
                    {
