...
-- experience
INSERT INTO entries(frequency, priority, owner, header, content, type, begin, end, gpa, location)
VALUES (2, 2, 'tdokas', 'education','University of Michigan', 0, '2020-08', '2023-05', 3.4, "Ann Arbor, MI");
INSERT INTO entries(frequency, priority, owner, header, content, type, begin, end, gpa, location)
VALUES (2, 2, 'tdokas', 'education','Michigan State University', 0, '2019-08', '2020-05', 3.9, "Ann Arbor, MI");
INSERT INTO entries(frequency, priority, owner, header, content, type, begin, end, location)
VALUES (2, 2, 'tdokas', 'experience','MBNI', 0, '2020-08', '2023-05', "Ann Arbor, MI");
...
INSERT INTO entries(frequency, priority, owner, header, content, type, begin, end, gpa, location)
VALUES (1, 1, 'tdokas', 'education','test school', 0, '1970-01', '2023-05', 0.0, "Ann Arbor, MI");
INSERT INTO entries(frequency, priority, owner, header, content, type, begin, end, location)
VALUES (1, 1, 'tdokas', 'experience','test work', 0, '2020-08', '2023-05', "Ann Arbor, MI");
INSERT INTO resume_to_entry(resumeid, entryid, owner)
VALUES (2, 8, 'tdokas');
INSERT INTO resume_to_entry(resumeid, entryid, owner)
VALUES (2, 9, 'tdokas');